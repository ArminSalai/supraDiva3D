...
//Orbit controls and control buttons
...
//Loading all models
var supraCharger2, supraCharger, ecoCharger;
...
var supraChargerLoader = new GLTFLoader(manager);
supraChargerLoader.setDRACOLoader(dracoLoader);
supraChargerLoader.load("assets/models/supraCharge.glb", function (glb) {
    supraCharger = glb.scene;
    supraCharger.visible = false;
    scene.add(supraCharger);
    supraCharger.matrixAutoUpdate = false;
    supraCharger.updateMatrix();
});

var ecoChargerLoader = new GLTFLoader(manager);
ecoChargerLoader.setDRACOLoader(dracoLoader);
ecoChargerLoader.load("assets/models/ecoCharger.glb", function (glb) {
    ecoCharger = glb.scene;
    ecoCharger.visible = false;
    scene.add(ecoCharger);
    ecoCharger.matrixAutoUpdate = false;
    ecoCharger.scale.set(1.1,1.1,1.1);
    ecoCharger.updateMatrix();
});
...
//Switching mmodels right
var rightArr = document.querySelector(".rightArrow");
rightArr.addEventListener('click', function() {
    switch(currentObject) {
        case 0:
            supraCharger2.visible = false;
            supraCharger.visible = true;
            ecoCharger.visible = false;
